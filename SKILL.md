...
# kafka — Skill: Package Development

> Workflow for kafka (packages/ts/kafka). Execute this workflow before, during, and
...
- This package is published (`@omnixys/kafka-ts`); consumers pin versions and rely on SemVer.
